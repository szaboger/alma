...
if (isset($_POST['reg_user'])) {
  ...
  if (empty($username)) { array_push($errors, "Felhasználónév szükséges"); }
  ...
  if ($user) { // if user exists
    if ($user['username'] === $username) {
      array_push($errors, "Ezzel az felhasználónévvel már létezik fiók");
    }

    if ($user['email'] === $email) {
      array_push($errors, "Ezzel az email címmel már létezik fiók");
    }
  }
